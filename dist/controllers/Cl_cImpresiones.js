...
export default class Cl_cImpresiones {
    ...
    actualizarVista() {
        ...
        if (filtro) {
            solicitudesFiltradas = solicitudesFiltradas.filter((reg) => reg.modelo.codigoOrden.toLowerCase().includes(filtro));
        }
    ...
    handleServicioDisponibilidad(codigo, disponible) {
